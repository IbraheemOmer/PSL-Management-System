...
public class MultanController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Titles Where Team = 'Multan Sultans'");
            while (rs.next()) {
        ...
        try {
            con = DbConnector.getConnection();
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Players Where Team = 'Multan Sultans'");
            while (rs.next()) {
