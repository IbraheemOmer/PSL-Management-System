...
public class QuettaController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Titles Where Team = 'Quetta Gladiators'");
            while (rs.next()) {
        ...
        try {
            con = DbConnector.getConnection();
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Players Where Team = 'Quetta Gladiators'");
            while (rs.next()) {
